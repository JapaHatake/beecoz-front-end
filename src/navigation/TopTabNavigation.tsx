...
import { ConcludedPosts } from "../screens/Home/ConcludedPosts";
import { OpenedPosts } from "../screens/Home/OpenedPosts";
import { ProgressPosts } from "../screens/Home/ProgressPosts";
...
export const TopTabHomeNavigator = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Tab.Screen name="opened posts" component={OpenedPosts} options={{
          tabBarIcon: ({ focused }) => (
            <View style={{alignSelf: 'center', width: 100,height: 30 , justifyContent: 'center', alignItems: 'center'}}>
              <Text
                style={{
      ...
      <Tab.Screen name="conluded posts" component={ConcludedPosts} options={{
          tabBarIcon: ({ focused }) => (
            <View style={{alignSelf: 'center', width: 100,height: 30 , justifyContent: 'center', alignItems: 'center'}}>
              <Text
                style={{
